# as a point of creativity I added a function to convert
# water pressure in kilopascals (kPa) in pounds per square inch (psi)
...
def convert_to_psi(height):
    pressure_gain_from_water_height = 998.2 * 9.80665 * height / 1000
    psi = pressure_gain_from_water_height / 6.895
    return psi
...
def pressure_loss_from_pipe_reduction(larger_diameter, fluid_velocity, reynolds_number, smaller_diameter):
    ...
    pressure_loss_from_pipe_reduction = -k * 998.2 * fluid_velocity **2 / 2000
